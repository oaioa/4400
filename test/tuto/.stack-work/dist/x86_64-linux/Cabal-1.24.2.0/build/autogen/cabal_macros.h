...
/* package tuto-0.1.0.0 */
#define VERSION_tuto "0.1.0.0"
#define MIN_VERSION_tuto(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "tuto-0.1.0.0-1HexxdJ2kYu8U2s0fMBLRJ"

#define CURRENT_PACKAGE_KEY "tuto-0.1.0.0-1HexxdJ2kYu8U2s0fMBLRJ"
